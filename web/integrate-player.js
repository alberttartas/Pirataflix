// ============================================
// PLAYER COMPLETO - VERSÃO LIMPA E FINAL
// ============================================
...
function renderContinueWatching() {
    ...
    list.forEach(item => {
        ...
        html += `
        <div class="item-card continue-card" onclick="resumeFromContinue('${item.itemId}', '${item.category}', ${item.episodeIndex})">
            <img src="${urlCapa}" 
                 class="item-poster" 
